            ...
            <div>
                ...
                <div class="mt-4">
                    ...
                    <div class="flex gap-4 footer-social-links">
                        ...
                        <a href="https://www.instagram.com/qfitness24hrgym/" target="_blank" rel="noopener noreferrer" class="footer-social-link text-white hover:text-primary-green transition duration-300" aria-label="Instagram">
                            <svg class="w-6 h-6 footer-social-icon" fill="currentColor" viewBox="0 0 24 24">
